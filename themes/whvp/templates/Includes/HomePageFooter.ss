				...
				<div class="homepage-footer dark-grey-bg">
					<div class="img-list">
						...
						<div class="site-img">
							...
							<a href="{$BaseHref}site-images-info/image-c"   class="pos-top-left badge info-btn" 
						...
						<div class="site-img">
							...
							<a href="{$BaseHref}site-images-info/image-d"   class="badge info-btn pos-top-left" 
						...
						<div class="site-img">
							...
							<a href="{$BaseHref}site-images-info/image-e"   class="badge info-btn pos-top-left" 
						...
						<div class="site-img">
							...
							<a href="{$BaseHref}site-images-info/image-f"   class="badge info-btn pos-top-left" 
						...
						<div class="site-img">
							...
							<a href="{$BaseHref}site-images-info/image-g"   class="badge info-btn pos-top-left" 
